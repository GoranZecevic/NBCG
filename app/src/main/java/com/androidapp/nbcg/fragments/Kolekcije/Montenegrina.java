...
public class Montenegrina extends Fragment {
    ...
    int[] images = {
            R.drawable.montenegrina1,
            R.drawable.montenegrina2,
            R.drawable.montenegrina3,
            R.drawable.montenegrina4
    };
    ...
    public static Montenegrina newInstance(String param1, String param2) {
        Montenegrina fragment = new Montenegrina();
        return  fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_montenegrina, null);
        ...
        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.MONTENEGRINA_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.MONTENEGRINA_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.MONTENEGRINA_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.MONTENEGRINA_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.MONTENEGRINA_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.MONTENEGRINA_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_montenegrina_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_montenegrina_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_montenegrina_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_montenegrina_body)); break;
        }
