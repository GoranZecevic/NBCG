...
public class KoncertFilter extends Fragment {
    private KoncertFilter.OnFragmentInteractionListener mListener;
    ...
    public KoncertFilter() {
    }

    public static KoncertFilter newInstance(String param1, String param2) {
        KoncertFilter fragment = new KoncertFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_koncert_filter, container, false);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_KONCERT_FILTER ;
