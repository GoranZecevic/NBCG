...
public class IzlozbaFilter extends Fragment {
    private IzlozbaFilter.OnFragmentInteractionListener mListener;
    ...
    public IzlozbaFilter() {
    }

    public static IzlozbaFilter newInstance(String param1, String param2) {
        IzlozbaFilter fragment = new IzlozbaFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_izlozba_filter, container, false);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_IZLOZBA_FILTER ;
