...
public class FototipskaIzdanjaFilter extends Fragment {
    ...
    public FototipskaIzdanjaFilter() {
    }

    public static FototipskaIzdanjaFilter newInstance(String param1, String param2) {
        FototipskaIzdanjaFilter fragment = new FototipskaIzdanjaFilter();
        return fragment;
    }
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_FOTOTIPSKA_IZDANJA_FILTER ;
