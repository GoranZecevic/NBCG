...
public class COBISS extends Fragment {
    ...
    public static COBISS newInstance(String param1, String param2) {
        COBISS fragment = new COBISS();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_cobis, container, false);

        textPopulate();

        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.COBISS_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.COBISS_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.COBISS_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.COBISS_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.COBISS_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.COBISS_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_cobiss_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_cobiss_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_cobiss_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_cobiss_body)); break;
        }
