...
public class ECG extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_ecg, container, false);

        textPopulate();

        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.ECG_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.ECG_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.ECG_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.ECG_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.ECG_TW_MNE, R.id.vb_btn_tw);
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_ecg_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_ecg_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_ecg_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_ecg_body)); break;
        }
