...
public class CgBibliografija extends Fragment {
    ...
    public void textPopulate(){
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_cg_bibl_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_cg_bibl_body)); break;
        }
