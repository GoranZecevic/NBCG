...
public class VijestiFilter extends Fragment {
    ...
    public VijestiFilter() {
    }

    public static VijestiFilter newInstance(String param1, String param2) {
        VijestiFilter fragment = new VijestiFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_vijesti_filter, container, false);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_VIJESTI_FILTER ;
