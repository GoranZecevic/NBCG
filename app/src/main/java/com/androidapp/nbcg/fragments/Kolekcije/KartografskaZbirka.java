...
public class KartografskaZbirka extends Fragment {
    ...
    public KartografskaZbirka() {
    }


    int[] images = {
            R.drawable.kartografskazbirka1,
            R.drawable.kartografskazbirka2,
            R.drawable.kartografskazbirka3,
            R.drawable.kartografskazbirka4,
            R.drawable.kartografskazbirka5
    };

    // TODO: Rename and change types and number of parameters
    public static KartografskaZbirka newInstance(String param1, String param2) {
        KartografskaZbirka fragment = new KartografskaZbirka();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_kartografska_zbirka, null);
        ...
        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.KARTOGRAFSKA_ZBIRKA_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.KARTOGRAFSKA_ZBIRKA_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.KARTOGRAFSKA_ZBIRKA_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.KARTOGRAFSKA_ZBIRKA_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.KARTOGRAFSKA_ZBIRKA_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.KARTOGRAFSKA_ZBIRKA_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_kartografska_zbirka_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_kartografska_zbirka_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_kartografska_zbirka_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_kartografska_zbirka_body)); break;
        }
