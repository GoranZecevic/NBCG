...
public class RukopisiArhivalije extends Fragment {
    ...
    int[] images = {
            R.drawable.rukopisiarhivalije1,
            R.drawable.rukopisiarhivalije2,
            R.drawable.rukopisiarhivalije3
    };

    private OnFragmentInteractionListener mListener;

    public RukopisiArhivalije() {
    }

    public static RukopisiArhivalije newInstance(String param1, String param2) {
        RukopisiArhivalije fragment = new RukopisiArhivalije();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_rukopisi_arhivalije, null);
        ...
        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.RUKOPISI_ARHIVALIJE_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.RUKOPISI_ARHIVALIJE_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.RUKOPISI_ARHIVALIJE_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.RUKOPISI_ARHIVALIJE_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.RUKOPISI_ARHIVALIJE_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.RUKOPISI_ARHIVALIJE_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_rukopisi_arhivalije_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_rukopisi_arhivalije_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_rukopisi_arhivalije_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_rukopisi_arhivalije_body)); break;
        }
