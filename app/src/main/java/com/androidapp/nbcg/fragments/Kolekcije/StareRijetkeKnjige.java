...
public class StareRijetkeKnjige extends Fragment {
    ...
    int[] images = {
            R.drawable.starerijetke1,
            R.drawable.starerijetke2,
            R.drawable.starerijetke3,
            R.drawable.starerijetke4,
            R.drawable.starerijetke5
    };

    private OnFragmentInteractionListener mListener;

    public StareRijetkeKnjige() {
    }

    public static StareRijetkeKnjige newInstance(String param1, String param2) {
        StareRijetkeKnjige fragment = new StareRijetkeKnjige();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_stare_rijetke_knjige, null);
        ...
        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.STARE_RIJETKE_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.STARE_RIJETKE_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.STARE_RIJETKE_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.STARE_RIJETKE_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.STARE_RIJETKE_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.STARE_RIJETKE_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_stare_rijetke_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_stare_rijetke_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_stare_rijetke_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_stare_rijetke_body)); break;
        }
