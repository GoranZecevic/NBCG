...
public class SerijskePublikacije extends Fragment {
    ...
    int[] images = {
            R.drawable.serijskepublikacije1,
            R.drawable.serijskepublikacije2,
            R.drawable.serijskepublikacije3
    };

    private OnFragmentInteractionListener mListener;

    public SerijskePublikacije() {
    }

    public static SerijskePublikacije newInstance(String param1, String param2) {
        SerijskePublikacije fragment = new SerijskePublikacije();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_serijske_publikacije, null);
        ...
        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.SERIJSKE_PUBLIKACIJE_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.SERIJSKE_PUBLIKACIJE_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.SERIJSKE_PUBLIKACIJE_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.SERIJSKE_PUBLIKACIJE_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.SERIJSKE_PUBLIKACIJE_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.SERIJSKE_PUBLIKACIJE_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_serijske_publikacije_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_serijske_publikacije_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_serijske_publikacije_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_serijske_publikacije_body)); break;
        }
