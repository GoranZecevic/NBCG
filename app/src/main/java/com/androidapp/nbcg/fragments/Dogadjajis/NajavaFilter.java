...
public class NajavaFilter extends Fragment {
    private NajavaFilter.OnFragmentInteractionListener mListener;
    ...
    public static NajavaFilter newInstance(String param1, String param2) {
        NajavaFilter fragment = new NajavaFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_najava_filter, container, false);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_NAJAVA_FILTER ;
