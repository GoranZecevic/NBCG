...
public class BiobibliografijaFilter extends Fragment {
    ...
    public BiobibliografijaFilter() {
    }

    public static BiobibliografijaFilter newInstance(String param1, String param2) {
        BiobibliografijaFilter fragment = new BiobibliografijaFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        thisFragment = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_biobibliografija_filter, null);
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_BIOBIBLIOGRAFIJA_FILTER;
