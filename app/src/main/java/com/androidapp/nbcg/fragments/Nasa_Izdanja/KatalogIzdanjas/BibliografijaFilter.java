...
public class BibliografijaFilter extends Fragment {
    ...
    public BibliografijaFilter() {
    }

    public static BibliografijaFilter newInstance(String param1, String param2) {
        BibliografijaFilter fragment = new BibliografijaFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        thisFragment = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_bibliografija_filter, null);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_BIBLIOGRAFIJA_FILTER ;
