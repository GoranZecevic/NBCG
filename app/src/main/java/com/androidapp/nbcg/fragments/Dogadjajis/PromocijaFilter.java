...
public class PromocijaFilter extends Fragment {
    private PromocijaFilter.OnFragmentInteractionListener mListener;
    ...
    public PromocijaFilter() {
    }

    public static PromocijaFilter newInstance(String param1, String param2) {
        PromocijaFilter fragment = new PromocijaFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_promocija_filter, container, false);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_PROMOCIJA_FILTER ;
