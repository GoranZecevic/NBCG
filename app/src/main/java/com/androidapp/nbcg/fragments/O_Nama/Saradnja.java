...
public class Saradnja extends Fragment {
    ...
    public static Saradnja newInstance(String param1, String param2) {
        Saradnja fragment = new Saradnja();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_saradnja, container, false);

        textPopulate();

        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.SARADNJA_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.SARADNJA_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.SARADNJA_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.SARADNJA_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.SARADNJA_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.SARADNJA_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_saradnja_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_saradnja_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_saradnja_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_saradnja_body)); break;
        }
