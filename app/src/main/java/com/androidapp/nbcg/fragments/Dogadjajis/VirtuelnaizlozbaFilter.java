...
public class VirtuelnaizlozbaFilter extends Fragment {
    private VirtuelnaizlozbaFilter.OnFragmentInteractionListener mListener;
    ...
    public VirtuelnaizlozbaFilter() {
    }

    public static VirtuelnaizlozbaFilter newInstance(String param1, String param2) {
        VirtuelnaizlozbaFilter fragment = new VirtuelnaizlozbaFilter();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_virtuelnaizlozba_filter, container, false);
        textPopulate();
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_VIRTUELNAIZLOZBA_FILTER ;
