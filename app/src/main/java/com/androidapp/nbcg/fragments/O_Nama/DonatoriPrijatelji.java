...
public class DonatoriPrijatelji extends Fragment {
    ...
    public DonatoriPrijatelji() {
    }

    public static DonatoriPrijatelji newInstance(String param1, String param2) {
        DonatoriPrijatelji fragment = new DonatoriPrijatelji();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_donatori_prijatelji, container, false);

        textPopulate();

        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.DONORI_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.DONORI_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.DONORI_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.DONORI_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.DONORI_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.DONORI_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_donatori_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_donatori_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_donatori_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_donatori_body)); break;
        }
