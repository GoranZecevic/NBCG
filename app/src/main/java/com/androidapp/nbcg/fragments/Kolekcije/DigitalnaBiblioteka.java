...
public class DigitalnaBiblioteka extends Fragment {
    ...
    public void textPopulate(){
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_dig_bibl_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_dig_bibl_body)); break;
        }
