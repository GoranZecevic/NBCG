...
public class OsnovniFond extends Fragment {
    ...
    int[] images = {
            R.drawable.osnovnifond,
            R.drawable.osnovnifond1,
            R.drawable.osnovnifond2,
            R.drawable.osnovnifond3,
            R.drawable.osnovnifond4
    };
    ...
    public static OsnovniFond newInstance(String param1, String param2) {
        OsnovniFond fragment = new OsnovniFond();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_osnovni_fond, null);

        textPopulate();

        if(language == 1){
            imageButtonHandlerWeb(ApiUrls.OSNOVNI_FOND_FB_ENG, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.OSNOVNI_FOND_TW_ENG, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.OSNOVNI_FOND_LN_ENG, R.id.vb_btn_ln);
        }

        if(language == 0) {
            imageButtonHandlerWeb(ApiUrls.OSNOVNI_FOND_FB_MNE, R.id.vb_btn_fb);
            imageButtonHandlerWeb(ApiUrls.OSNOVNI_FOND_TW_MNE, R.id.vb_btn_tw);
            imageButtonHandlerWeb(ApiUrls.OSNOVNI_FOND_LN_MNE, R.id.vb_btn_ln);
        }
    ...
    public void textPopulate(){
        ...
        String titleStr= "";
        switch (language){
            case 0: titleStr = helper.mne(getResources().getString(R.string.str_osnovni_fond_title)); break;
            case 1: titleStr = helper.eng(getResources().getString(R.string.str_osnovni_fond_title)); break;
        }
        ...
        String bodyStr= "";
        switch (language){
            case 0: bodyStr = helper.mne(getResources().getString(R.string.str_osnovni_fond_body)); break;
            case 1: bodyStr = helper.eng(getResources().getString(R.string.str_osnovni_fond_body)); break;
        }
