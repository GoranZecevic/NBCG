...
public class PrirucniciFilter extends Fragment {
    ...
    public static PrirucniciFilter newInstance(String param1, String param2) {
        PrirucniciFilter fragment = new PrirucniciFilter();
        return fragment;
    }
    ...
    public void PARSEDATA() {
        final String URL = ApiUrls.GET_PRIRUCNICI_FILTER ;
